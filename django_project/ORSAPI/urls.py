...
from .rest.DepartmentRestCtl import DepartmentRestCtl, DepartmentPreloadRestCtl
...
urlpatterns = [
    ...
    path("api/Department/", DepartmentRestCtl.as_view()),
    path("api/Department/search/", DepartmentRestCtl.search_view(), name="department-search"),
    path("api/Department/preload/", DepartmentPreloadRestCtl.as_view()),
    path("api/Department/<int:id>/", DepartmentRestCtl.as_view()),
]
